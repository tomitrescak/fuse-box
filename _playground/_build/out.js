    ...
    FuseBox.pkg('clan-fp', {}, function (___scope___) {
        ...
        ___scope___.file('vdom.js', function (exports, require, module, __filename, __dirname) {
            ...
            var vdom = function vdom() {
                ...
                var parseSelector = function parseSelector(s) {
                    var test = null, tagreg = tagName_regex().exec(s), tag = tagreg && tagreg.slice(1)[0], reg = class_id_regex(), vdom = Object.create(null);
                    if (tag)
                ...
                var m = function m(selector) {
                    ...
                    if (attrs.tag || !((typeof attrs === 'undefined' ? 'undefined' : _typeof(attrs)) === 'object') || attrs instanceof Array || attrs instanceof Function) {
                        if (attrs instanceof Array)
                            children.unshift.apply(children, _toConsumableArray(attrs));
                        else
                ...
                var update = function update() {
                    if (!mnt)
                        return;
                    var _mnt = mnt, _mnt2 = _slicedToArray(_mnt, 2), el = _mnt2[0], fn = _mnt2[1];
                    render(fn, el);
                };
                ...
                var setAttrs = function setAttrs(_ref2, el) {
                    var attrs = _ref2.attrs, id = _ref2.id, className = _ref2.className, __hash = _ref2.__hash;
                    el.className = '';
                    el.style = '';
                    if (attrs) {
                ...
                var createTag = function createTag() {
                    ...
                    var tag = vdom.tag, attrs = vdom.attrs, id = vdom.id, className = vdom.className, unload = vdom.unload, shouldUpdate = vdom.shouldUpdate, config = vdom.config, __hash = vdom.__hash, shouldExchange = !el || !el.tagName || tag && el.tagName.toLowerCase() !== tag.toLowerCase(), _shouldUpdate = !(shouldUpdate instanceof Function) || shouldUpdate(el);
                    if (!attrs)
                        return;
                ...
                var applyUpdates = function applyUpdates(vdom, el) {
                    ...
                    if (vdom instanceof Array || vdom.children) {
                        var vdom_children = flatten(vdom instanceof Array ? vdom : vdom.children), el_children = vdom instanceof Array ? parent.childNodes : _el.childNodes;
                ...
                var toHTML = function toHTML(_vdom) {
                    ...
                    if ((typeof _vdom === 'undefined' ? 'undefined' : _typeof(_vdom)) !== 'object')
                        return new Promise(function (r) {
                            return r(_vdom);
                        });
                    return (_vdom.resolve ? _vdom.resolve() : Promise.resolve()).then(function (vdom) {
                        ...
                        var _vdom2 = vdom, tag = _vdom2.tag, id = _vdom2.id, className = _vdom2.className, attrs = _vdom2.attrs, children = _vdom2.children, instance = _vdom2.instance, _id = id || attrs && attrs.id ? ' id="' + (id || attrs && attrs.id || '') + '"' : '', _class = className || attrs && attrs.className ? ' class="' + ((className || '') + ' ' + (attrs.className || '')).trim() + '"' : '';
                        ...
                        if (!inner && children)
                            return html.apply(undefined, _toConsumableArray(children)).then(function (str) {
        ...
        ___scope___.file('model.js', function (exports, require, module, __filename, __dirname) {
            ...
            var model = {
                ...
                init: function init() {
                    var types = void 0, required = void 0, logic = void 0;
                    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
                        args[_key] = arguments[_key];
                    }
                    args.map(function (x) {
        ...
        ___scope___.file('observable.js', function (exports, require, module, __filename, __dirname) {
            ...
            var obs = function obs(state) {
                ...
                fn.maybe = function (f) {
                    var success = obs(), error = obs(), cb = function cb(val) {
        ...
        ___scope___.file('hamt.js', function (exports, require, module, __filename, __dirname) {
            ...
            var set = exports.set = function set(root, key, val) {
                if (root.key === undefined && !root.children)
                    return node(key, val);
                var newroot = cloneNode(root), h = hash(key);
                    ...
                    if (r.key !== undefined) {
                        if (r.key === key || i === 0) {
                            ...
                            for (var j = i, __r = r, __n = n; j >= 0; j--) {
                                var vecr = vec(rh, j), vecn = vec(h, j);
            ...
            var unset = exports.unset = function unset(root, key) {
                var n = cloneNode(root), h = hash(key);
            ...
            var map = exports.map = function map(root, fn) {
                ...
                var d = cloneNode(root), c = d.children;
                if (c) {
                    for (var i in c) {
                        c[i] = map(c[i], fn);
                    }
        ...
        ___scope___.file('worker.js', function (exports, require, module, __filename, __dirname) {
            ...
            var farm = exports.farm = function farm(n) {
                ...
                var workers = Array(n).fill(1).map(function (x) {
                    ...
                    }), current = 0, iter = function iter() {
                        var _n = current;
                        ++current >= n && (current = 0);
                        return current;
                    }, pipe = void 0, onerror = void 0;
